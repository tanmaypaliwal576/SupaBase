...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    setMessage(
      "Signup successful! You can now log in through Email Confirmation Link."
    );
  };
      ...
      <div className="relative z-10 w-full max-w-md bg-[#0b0f17]/80 backdrop-blur-xl rounded-2xl p-8 shadow-2xl border border-white/10">
        <div className="flex flex-col items-center mb-8">
          ...
          <p className="text-sm text-white/60 mt-1">
            Welcome to GradMentor! Sign Up to continue.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-lg bg-cyan-500 hover:bg-cyan-600 transition font-medium text-black disabled:opacity-50"
          >
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-xs text-white/40">Or Login with</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>
        ...
        <div className="flex gap-3">
          <button
            ...
            disabled={loading}
            className="flex-1 py-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition flex items-center justify-center gap-2 disabled:opacity-50"
          >
            <img
          ...
          <button
            ...
            disabled={loading}
            className="flex-1 py-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 transition flex items-center justify-center disabled:opacity-50"
          >
